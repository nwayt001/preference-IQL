...
class QHead(nn.Module):
    """
    MLP Q-network head that scales itself so that targets are always normalized to N(0, 1)
    """
    ...
    def forward(self, obs, action):
        ...
        # Bug fix: Q-head output should not be normalized.
        return Q_out
        #return self.normalizer(Q_out)
